...
public class OEVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OEVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OEVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OEVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OEVDateTimeConverter dateTimeConverter = new OEVStandardDateTimeConverter();

    public OEVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OEVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OEVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OEVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OEVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OEVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
