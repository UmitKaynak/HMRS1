...
public class OEVKPSPublicSoap
{
    ...
    public OEVKPSPublicSoap(){}

    public OEVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OEVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OEVExtendedSoapSerializationEnvelope envelope= new OEVExtendedSoapSerializationEnvelope(OEVExtendedSoapSerializationEnvelope.VER11);
